"""
Main module for MDP Average Reward Policy Iteration
...
def main():
    """
    Main function that sets up the MDP and runs policy iteration
    """
    print("MDP Average Reward Policy Iteration")
