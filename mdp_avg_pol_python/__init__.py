"""
MDP Average Reward Policy Iteration Package

This package implements Policy Iteration for Average Reward Markov Decision Processes (MDPs).
It is a Python translation of the original C code from the mdp/avg/pol directory.

Modules:
    - constants: Global constants and parameters
    - solver: Linear system solver for policy evaluation
    - pia: Policy Iteration Algorithm implementation
